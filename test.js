...
var curry = _interopRequire(require("./"));
...
describe("chickencurry", function () {
  ...
  it("should wrap the function if no argument to curry is passed", function () {
    ...
    expect(joinCurry(__, "_")("_", "chicken")).to.equal("_chicken_");
    expect(joinCurry("_", __)("-", "chicken")).to.equal("_chicken-");
    expect(joinCurry(__)(".")("curry")("$")).to.equal("$curry.");
    expect(joinCurry("_", __, "chicken")("-")).to.equal("_chicken-");
    expect(joinCurry(__, "_", "chicken")("-")).to.equal("-chicken_");
